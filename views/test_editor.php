...
<form method="POST" action="">
    ...
    <table>
        <tr>
        <td>Udostępniony dla uczniów</td> <td><input type="checkbox" name="published" <?= $testData['published'] ? 'checked' : '' ?>></td>
        </tr>
        <tr>
        <td>Współdzielony</td> <td><input type="checkbox" name="shared" <?= $testData['shared'] ? 'checked' : '' ?>></td>
        </tr>
    </table>
    <label>
